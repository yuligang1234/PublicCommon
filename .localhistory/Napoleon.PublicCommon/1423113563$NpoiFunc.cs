...
namespace Napoleon.PublicCommon
{
    public static class NpoiFunc
    {
        ...
        #region MemoryStream fileStream = dt.CreateSheet("", titles);fileStream.Seek(0, SeekOrigin.Begin);File(fileStream, "application/vnd.ms-excel", PublicFields.LogExcelName);
        ...
        public static MemoryStream CreateSheet(this DataTable dt, string[] title, string[] titleFileds,
            string topTitle = "")
        {
